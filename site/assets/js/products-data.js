  ...
  "products": [
    {
      ...
      "status": "available",
      "flavors": [
        { "name": "Sea Salt", "status": "available", "swatch": "#0F2740", "tagline": "Our signature crunch, kept simple.", "description": "Our founding flavour — a light dusting of sea salt over the puffed rice cake, so the natural, nutty taste of the rice still leads. Clean and simple enough for a lunchbox, a desk drawer, or straight out of the sleeve. Flavoured with: rice, sea salt." },
        { "name": "Peri Peri", "status": "coming-soon", "swatch": "#E2472B", "tagline": "Bold, smoky heat in every bite.", "description": "A bold, smoky peri-peri seasoning over the same puffed rice base, built for anyone who wants their crunch with a kick. Good on its own, better with a cooling dip alongside. Flavoured with: rice, paprika, garlic, chilli." },
        { "name": "Herb & Garlic", "status": "coming-soon", "swatch": "#4F8A3D", "tagline": "Garden-fresh and savoury.", "description": "A savoury blend of herbs and roasted garlic over the puffed rice cake — lighter on heat, bigger on aroma. For anyone who wants more than plain salt without going spicy. Flavoured with: rice, roasted garlic, mixed herbs." },
        { "name": "Tomato Basil", "status": "coming-soon", "swatch": "#C0392B", "tagline": "Sun-ripened tang, Italian twist.", "description": "Tangy tomato with a hint of basil, an Italian-inspired twist on the classic rice cake. Bright and tangy enough to eat on its own, or topped with a light spread. Flavoured with: rice, sun-dried tomato, basil." },
        { "name": "Chaat Masala", "status": "coming-soon", "swatch": "#C77C1E", "tagline": "Tangy, spiced, unmistakably Indian.", "description": "Our take on classic street-food chaat masala, dusted over the puffed rice cake — tangy, spiced, and instantly familiar. For when you want your snack to taste like home. Flavoured with: rice, chaat masala spice blend." }
      ],
